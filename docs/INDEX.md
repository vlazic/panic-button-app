...
- [poc/OVERVIEW.md](./poc/OVERVIEW.md) - Kompletan pregled PoC-a
- [poc/USER_FLOWS.md](./poc/USER_FLOWS.md) - Detaljni user flow sa wireframe-ovima
- [poc/DATA_MODEL.md](./poc/DATA_MODEL.md) - Schema baze
- [poc/IMPLEMENTATION.md](./poc/IMPLEMENTATION.md) - Struktura koda
- [poc/DEPLOYMENT.md](./poc/DEPLOYMENT.md) - Kako deployovati
...
📄 **Detaljna dokumentacija:**
- [full-system/OVERVIEW.md](./full-system/OVERVIEW.md) - Pregled punog sistema
- [full-system/ROLES_AND_PERMISSIONS.md](./full-system/ROLES_AND_PERMISSIONS.md) - Sistem uloga
- [full-system/ALARM_LIFECYCLE.md](./full-system/ALARM_LIFECYCLE.md) - Životni ciklus alarma
- [full-system/RESPONDER_SYSTEM.md](./full-system/RESPONDER_SYSTEM.md) - Smene i preuzimanje
- [full-system/TELEGRAM_INTEGRATION.md](./full-system/TELEGRAM_INTEGRATION.md) - Telegram integracija
- [full-system/ADMIN_PANEL.md](./full-system/ADMIN_PANEL.md) - Admin funkcije
- [full-system/STATISTICS.md](./full-system/STATISTICS.md) - Statistike za policiju
- [full-system/SECURITY.md](./full-system/SECURITY.md) - Bezbednost
...
### Specifikacije
- [specs/MVP_DEFINITION.md](./specs/MVP_DEFINITION.md) - Šta je PoC vs MVP vs Pun sistem
- [specs/REQUIREMENTS.md](./specs/REQUIREMENTS.md) - Svi zahtevi detaljno
- [specs/FEATURE_COMPARISON.md](./specs/FEATURE_COMPARISON.md) - Uporedni pregled funkcija

### Arhitektura (draft)
- [architecture/OVERVIEW.md](./architecture/OVERVIEW.md) - Dijagrami sistema
- [architecture/DATA_MODEL.md](./architecture/DATA_MODEL.md) - Kompletna schema baze
- [architecture/TECH_STACK.md](./architecture/TECH_STACK.md) - Zašto ove tehnologije
- [architecture/DEPLOYMENT.md](./architecture/DEPLOYMENT.md) - CI/CD i hosting
- [architecture/COST_ANALYSIS.md](./architecture/COST_ANALYSIS.md) - Detaljni troškovi

### Implementacija (za developere)
- [implementation/SETUP_GUIDE.md](./implementation/SETUP_GUIDE.md) - Korak po korak setup
- [implementation/CONVEX_FUNCTIONS.md](./implementation/CONVEX_FUNCTIONS.md) - Backend API
- [implementation/FRONTEND_COMPONENTS.md](./implementation/FRONTEND_COMPONENTS.md) - React komponente
- [implementation/TELEGRAM_BOT.md](./implementation/TELEGRAM_BOT.md) - Telegram bot setup

### Pozadina projekta
- [PROJECT_OVERVIEW.md](./PROJECT_OVERVIEW.md) - Motivacija, ciljevi, kontekst
